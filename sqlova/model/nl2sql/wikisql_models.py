...
class Seq2SQL_v1(nn.Module):
    ...
    def forward(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs,
        ...
        '''
        if constraint:
            # print('Seq2SQL_v1.forward function. Using constraints.')
...
class SAP(nn.Module):
    ...
    def forward(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs, pr_sc, show_p_sa=False,
        ...
        # print("SAP constraint={}, hS={}, n_agg_ops={}, s_sa={}".format(constraint,self.hS, self.n_agg_ops, s_sa))
        if constraint:
            assert tb is not None
            # print("SAP:{}".format(s_sa))
...
class FT_s2s_1(nn.Module):
    ...
    def EG_forward(self, wenc_s2s, l_input, cls_vec, pnt_start_tok, pnt_end_tok,
                   i_sql_vocab, i_nlu, i_hds,  # for EG
                   tokens, nlu, nlu_t, hds, tt_to_t_idx,  # for EG
                   tb, engine, beam_size=4, beam_only=True):
